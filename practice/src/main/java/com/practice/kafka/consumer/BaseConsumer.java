...
public class BaseConsumer<K extends Serializable, V extends Serializable> {
    ...
    private void shutdownHookToRuntime(KafkaConsumer<K, V> kafkaConsumer) {
        ...
        //when main thread is shut down, another thread call the KafkaConsumer wakeup() method.
...
//        }
    ...
    private void pollCommitAsync(long durationMilis) throws WakeupException, Exception {
        ConsumerRecords<K, V> consumerRecords = this.kafkaConsumer.poll(Duration.ofMillis(durationMilis));
    ...
    public static void main(String[] args) {
        ...
        props.setProperty(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "13.124.30.1:9092");
